...
public abstract class CFC_Command
{
    protected CyroFunCommands plugin;
    ...
    public void setup(final CyroFunCommands plugin, final CommandSender commandSender, final Class<?> commandClass)
    {
        this.plugin = plugin;
    ...
    public boolean senderHasPermission()
    {
        ...
        {
            CFC_Log.warning(commandClass.getName() + " is missing permissions annotation.");
        }
        return true;
    }
